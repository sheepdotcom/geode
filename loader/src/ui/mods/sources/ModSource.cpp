...
ModSource::ModSource(Mod* mod) : m_value(mod) {geode::log::debug("source this {} {}", reinterpret_cast<uintptr_t>(&m_value), reinterpret_cast<uintptr_t>(&m_availableUpdate));}
ModSource::ModSource(server::ServerModMetadata&& metadata) : m_value(metadata) {geode::log::debug("source this online {} {}", reinterpret_cast<uintptr_t>(&m_value), reinterpret_cast<uintptr_t>(&m_availableUpdate));}
